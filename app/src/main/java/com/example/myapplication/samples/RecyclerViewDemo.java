...
ArrayList<String> personNames =new ArrayList<>(Arrays.asList("Person 1","Person 2","Person 3","Person 4",
        "Person 5","Person 6","Person 7","Person 8","Person 9","Person 10","Person 11",
        "Person 12","Person 13","Person 14"));
ArrayList<Integer> personImages =new ArrayList<>(Arrays.asList(R.drawable.person1,R.drawable.person2,R.drawable.person3,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomAdapterRecycler customAdapterRecycler=new CustomAdapterRecycler(getApplicationContext(),personImages,personNames);
